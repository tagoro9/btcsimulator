    ...
    DateTimePicker = function (element, options) {
        ...
        getTemplate = function (pickDate, pickTime, collapse) {
            if (pickDate && pickTime) {
                return (
                    '<div class="bootstrap-datetimepicker-widget dropdown-menu-date" style="z-index:9999 !important;">' +
                ...
                return (
                    '<div class="bootstrap-datetimepicker-widget dropdown-menu-date">' +
                        '<div class="timepicker">' + tpGlobal.getTemplate() + '</div>' +
                    '</div>'
                );
            } else {
