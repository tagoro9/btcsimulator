...
module.exports = class Controller extends Chaplin.Controller
	...
	beforeAction: (params, route) ->
		...
		@waitForContinue () -> @createLayout @layouts[@layout] if @layout?
	...
	createLayout: (layout) -> @reuse region, require("views/layout/#{region}-view") for region in layout
	...
	getName: ->	@name.replace("Controller", '').dasherize()
	...
	handleLogout: -> @redirectToName 'login'

	# Handle a dashboard event
	handleDashboard: -> @redirectToName 'dashboard'
